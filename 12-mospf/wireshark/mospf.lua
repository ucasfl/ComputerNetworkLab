do 
	...
	local f_lsa_subnet = ProtoField.ipv4("mospf_lsa.subnet", "Subnet of the Interface")
	...
	p_mospf_lsa.fields = { f_lsa_subnet, f_lsa_mask, f_lsa_rid }
	...
	function p_mospf.dissector(buf, pkt, root)
		...
		then
			...
			do 
				...
				lsa:add(f_lsa_subnet, buf(24+i*12,4))
